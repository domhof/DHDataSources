#
# Be sure to run `pod lib lint DHDataSources.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'domhof' => 'me@dominikhofer.com' }
  s.source           = { :git => 'https://github.com/domhof/DHDataSources.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'DHDataSources/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DHDataSources' => ['DHDataSources/Assets/*.png']
  # }
